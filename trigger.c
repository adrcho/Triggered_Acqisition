...
const int decimation = 4;    // decimation: [1;8;64;1024;8192;65536]
const int N= 3125;			// desired length of trace (1,..., 16383) for 100us recording 
...
int main(void) 
{
	...
	int trig_sig_freq=50000;     // generation of a trigger signal
	int trig_sig_amp=1;
